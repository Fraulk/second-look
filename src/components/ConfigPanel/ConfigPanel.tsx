            ...
            <div className="config-list">
                ...
                {config.blurBool && (
                    <div className="config-item full">
                        ...
                        <div className="simple-range">
                            <input type="range" id="blur" min="0" max="10" value={config.blur ?? 0} onChange={(e) => onConfigChange({ ...config, blur: +e.target.value })} />
                ...
                {config.opacityBool && (
                    <div className="config-item full">
                        ...
                        <div className="simple-range">
                            <input type="range" id="opacity" min="0" max="1" step=".05" value={config.opacity ?? 1} onChange={(e) => onConfigChange({ ...config, opacity: +e.target.value })} />
                            <span>{Math.floor((config.opacity ?? 1) * 100)}%</span>
                        </div>
                    </div>
                )}
                <div className="config-item">
